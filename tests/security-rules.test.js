...
assert.match(firestore, /locationDataIsValid/);
assert.match(firestore, /item\.latitude >= -90/);
assert.match(firestore, /item\.longitude <= 180/);
assert.match(firestore, /item\.address == data\.location/);
...
assert.match(complaintServer, /safeLocationData/);
